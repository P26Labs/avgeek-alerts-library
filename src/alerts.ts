...
import { EmailSandboxFlightAdd } from './alerts';
...
import { EmailFlightAutoCheckInSkipped } from './alerts';
...
class AvgeekAlerts {
    ...
    emailSandboxFlightAdd = (data: { email_body: EmailSandboxFlightAdd, email_recipients: string[] | string }) => this.sendEmail({ endpoint: '/email/flight-add-sandbox', ...data });
    ...
    emailFlightAutoCheckInSkipped = (data: { email_body: EmailFlightAutoCheckInSkipped, email_recipients: string[] | string }) => this.sendEmail({ endpoint: '/email/flight-auto-check-in-skipped', ...data });
