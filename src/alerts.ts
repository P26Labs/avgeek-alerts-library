...
class AvgeekAlerts {
    ...
    emailFlightAutoCheckInSkipped = (data: { email_body: EmailFlightAutoCheckInSkipped, email_recipients: string[] | string, email_attachment_url: string }) => this.sendEmail({ endpoint: '/email/flight-auto-check-in-skipped', ...data });
