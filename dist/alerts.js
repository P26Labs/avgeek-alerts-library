...
var AvgeekAlerts = /** @class */ (function () {
    function AvgeekAlerts(token, environment) {
    ...
    AvgeekAlerts.prototype.getHello = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.axios_client.get('/hello')];
                    case 1:
                        response = _a.sent();
                        return [2 /*return*/, {
